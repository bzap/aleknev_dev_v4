...
const GlowContainer2 = () => {
    return (
        <div
            ...
            // }}
        >
            <div className="relative z-30 blur-3xl  ">
                <svg
                    width={"70em"}
                    height={"70em"}
                    viewBox="0 0 200 200"
                ...
                >
                    ...
                    {/* <defs>
                        <radialGradient id="fill" cx="50%" cy="50%">
                            <stop offset="0%" stop-color="#ffa8fe"></stop>
                            <stop offset="100%" stop-color="#c2edff"></stop>
                        </radialGradient>
                    </defs> */}
                    <defs>
                        <radialGradient id="fill" cx="50%" cy="50%">
                            <stop offset="0%" stop-color="#ee3feb"></stop>
                            <stop offset="100%" stop-color="#81d9ff"></stop>
                        </radialGradient>
                    </defs>
