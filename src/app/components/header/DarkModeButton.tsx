...
const iconClassName: string =
    "fill-zinc-400 hover:fill-zinc-800 dark:hover:fill-zinc-300 dark:hover:rotate-45 hover:rotate-12 active:fill-zinc-300 dark:active:fill-zinc-600 transition select-none";
